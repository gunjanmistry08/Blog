...
=======
    ...
    path('password-reset-confirm/<uidb64>/<token>',auth_views.PasswordResetConfirmView.as_view(template_name='users/password-reset-confirm.html'), name='password-reset-confirm'),
>>>>>>> 8d00d6c2d8df2c00afe5693d1162386bb63e85fc
]
